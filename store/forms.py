...
class RegistrationForm(UserCreationForm):
    ...
    class Meta:
        ...
        labels = {'email': 'Email'}
        widgets = {'first_name': forms.TextInput(attrs={'class': 'form-control', 'placeholder':'First Name'}),'last_name': forms.TextInput(attrs={'class': 'form-control', 'placeholder':'Last Name'}),'username': forms.TextInput(attrs={'class': 'form-control', 'placeholder':'Username'})}
...
class ProductForm(forms.ModelForm):
    class Meta:
        model = Product
        fields = ['title', 'slug', 'sku', 'short_description', 'detail_description', 
                  'product_image', 'price', 'stock', 'category', 'brand', 'is_active', 'is_featured']
