...
class Address(models.Model):
    ...
    locality = models.CharField(max_length=150, verbose_name="Line 1")
    city = models.CharField(max_length=150, verbose_name="Line 2")
...
class Brand(models.Model):
    ...
    logo = models.ImageField(upload_to='category', blank=True, null=True, verbose_name="Brand Logo")
...
class Product(models.Model):
    ...
    brand = models.ForeignKey(Brand, verbose_name="Product Brand", on_delete=models.CASCADE,null=True)
    is_active = models.BooleanField(verbose_name="Is Active?")
    is_featured = models.BooleanField(verbose_name="Is Featured?")
    created_at = models.DateTimeField(auto_now_add=True, verbose_name="Created Date")
    updated_at = models.DateTimeField(auto_now=True, verbose_name="Updated Date")
